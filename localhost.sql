...
--
-- Host: localhost
-- Generation Time: Mar 14, 2020 at 03:22 PM
...
-- Database: `econapp`
--
CREATE DATABASE IF NOT EXISTS `econapp` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `econapp`;
...
--
ALTER TABLE `attendances`
  MODIFY `idattendances` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `attendances`
  ADD CONSTRAINT `fk_attendances_class1` FOREIGN KEY (`class_idclass`) REFERENCES `class` (`idclass`),
  ADD CONSTRAINT `fk_attendances_student1` FOREIGN KEY (`student_idstudent`) REFERENCES `student` (`idstudent`);

--
-- Constraints for table `class`
--
ALTER TABLE `class`
  ADD CONSTRAINT `fk_class_class_locations1` FOREIGN KEY (`class_locations_idclass_locations`) REFERENCES `class_locations` (`idclass_locations`),
  ADD CONSTRAINT `fk_class_class_types1` FOREIGN KEY (`class_types_idclass_types`) REFERENCES `class_types` (`idclass_types`),
  ADD CONSTRAINT `fk_class_user1` FOREIGN KEY (`user_iduser`) REFERENCES `user` (`iduser`),
  ADD CONSTRAINT `fk_class_years1` FOREIGN KEY (`years_idyears`) REFERENCES `years` (`idyears`);

--
-- Constraints for table `class_payment`
--
ALTER TABLE `class_payment`
  ADD CONSTRAINT `fk_class_payment_student1` FOREIGN KEY (`student_idstudent`) REFERENCES `student` (`idstudent`);

--
-- Constraints for table `collection_numbers`
--
ALTER TABLE `collection_numbers`
  ADD CONSTRAINT `fk_collections_idcollections` FOREIGN KEY (`collections_idcollections`) REFERENCES `collections` (`idcollections`);

--
-- Constraints for table `exams`
--
ALTER TABLE `exams`
  ADD CONSTRAINT `fk_exams_exam_types1` FOREIGN KEY (`exam_types_idexam_types`) REFERENCES `exam_types` (`idexam_types`),
  ADD CONSTRAINT `fk_exams_model_papers1` FOREIGN KEY (`model_papers_idmodel_papers`) REFERENCES `model_papers` (`idmodel_papers`),
  ADD CONSTRAINT `fk_model_papers_class1` FOREIGN KEY (`class_idclass`) REFERENCES `class` (`idclass`);

--
-- Constraints for table `exam_results`
--
ALTER TABLE `exam_results`
  ADD CONSTRAINT `fk_exam_results_exams1` FOREIGN KEY (`exams_idexams`) REFERENCES `exams` (`idexams`),
  ADD CONSTRAINT `fk_exam_results_student1` FOREIGN KEY (`student_idstudent`) REFERENCES `student` (`idstudent`);
...
ALTER TABLE `student`
  ...
  ADD CONSTRAINT `fk_student_class_payment_types1` FOREIGN KEY (`class_payment_types_idclass_payment_types`) REFERENCES `class_payment_types` (`idclass_payment_types`),
  ADD CONSTRAINT `fk_student_student_types1` FOREIGN KEY (`student_types_idstudent_types`) REFERENCES `student_types` (`idstudent_types`);
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `fk_user_class_locations` FOREIGN KEY (`class_locations_idclass_locations`) REFERENCES `class_locations` (`idclass_locations`),
...
-- Database: `pfsystem`
--
CREATE DATABASE IF NOT EXISTS `pfsystem` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `pfsystem`;
...
(4, 'thilinajayakody', '1000:63c3e3c16d9eb89176fa4f290b9dc104:16176d607abc52aac41c006991a99e75e6db6289b2143741eafa4185f241c5c3c3d94046f52d34fc5d0980ec1a488009d6fe9c16afa319e1464300f9cc423276');
...
CREATE TABLE `questions` (
  ...
  `answer_types_idanswer_types` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE `questions`
  ...
  ADD KEY `fk_questions_answer_types1_idx` (`answer_types_idanswer_types`);
...
ALTER TABLE `results`
  ...
  ADD KEY `fk_results_users_idx` (`users_idusers`),
  ADD KEY `fk_results_questions1_idx` (`questions_idquestions`),
  ADD KEY `fk_results_answers1_idx` (`answers_idanswers`);
...
--
ALTER TABLE `questions`
  ADD CONSTRAINT `fk_questions_answer_types1` FOREIGN KEY (`answer_types_idanswer_types`) REFERENCES `answer_types` (`idanswer_types`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `results`
--
ALTER TABLE `results`
  ADD CONSTRAINT `fk_results_answers1` FOREIGN KEY (`answers_idanswers`) REFERENCES `answers` (`idanswers`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_results_questions1` FOREIGN KEY (`questions_idquestions`) REFERENCES `questions` (`idquestions`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_results_users` FOREIGN KEY (`users_idusers`) REFERENCES `users` (`idusers`) ON DELETE NO ACTION ON UPDATE NO ACTION;
--
-- Database: `phpmyadmin`
--
...
('root', '[{\"db\":\"econapp\",\"table\":\"collection_numbers\"},{\"db\":\"econapp\",\"table\":\"collections\"},{\"db\":\"econapp\",\"table\":\"access_permissions\"},{\"db\":\"econapp\",\"table\":\"sub_menu\"},{\"db\":\"econapp\",\"table\":\"user\"}]');
...
('econapp', 'collection_numbers', 'phone_number');
...
('root', '2020-03-14 14:22:39', '{\"Console\\/Mode\":\"collapse\"}');
