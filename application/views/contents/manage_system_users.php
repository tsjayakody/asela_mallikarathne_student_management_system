                ...
                <form id="createUser" action="<?php echo base_url() ?>user_controller/create_user" method="post"
                    ...
                    <div class="card ">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <select class="selectpicker" id="locationSelect" data-size="7" data-width="100%"
                                        data-style="btn btn-primary btn-round" title="Class Locations">
                                        <option disabled selected>Class Locations</option>
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <select class="selectpicker" id="typeSelect" data-size="7" data-width="100%"
                                        data-style="btn btn-primary btn-round" title="User Type">
