    ...
    public function create_user() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $user_data = array(
                ...
                'class_locations_idclass_locations' => $_POST['location'],
        ...
        if($stat->num_rows() > 0) {
            ...
            $data = array(
                ...
                'user' => array(
                    ...
                    'class_location' => $user->class_locations_idclass_locations,
	...
	public function new_pass_get() {
    	...
    	curl_setopt_array(
			...
			array(
				...
				CURLOPT_URL => 'https://sms.textware.lk:5001/sms/send_sms.php?username='.$username.'&password='.$password.'&src=TheEconClz&dst='.$phone_number.'&msg=Econ%20System%20OTP:%20'.$otp.'&dr=1',
